 ...
 * @Description: 
 * @Author: zhuangshunan
 * @Date: 2023-01-27 21:11:40
 * @LastEditors: zhuangshunan
 * @LastEditTime: 2023-01-27 21:45:32
 */
// ============= Test Cases =============
...
// ============= Your Code Here =============
// 参考：https://github.com/type-challenges/type-challenges/issues/16430
type StringToUnion<S> =
  S extends `${infer F}${infer R}` ? F | StringToUnion<R> : S;
